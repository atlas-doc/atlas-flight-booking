...
EXPECTED: dict[tuple[BusinessStage, int], tuple[str, CommandStatus, bool]] = {
    ...
    (BusinessStage.ORDER, 323): ("PASSENGER_INFO_INVALID", CommandStatus.ACTION_REQUIRED, False),
    ...
    (BusinessStage.ORDER, 410): ("PASSENGER_INFO_INVALID", CommandStatus.ACTION_REQUIRED, False),
