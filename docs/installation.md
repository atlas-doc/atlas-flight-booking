...
```bash
uv tool install --python 3.12 git+https://github.com/atlas-doc/atlas-flight-booking.git@v0.3.5
```
...
The version command should report `atlas-flight 0.3.5`.
...
```bash
uv tool install --force --python 3.12 git+https://github.com/atlas-doc/atlas-flight-booking.git@v0.3.5
```
